...
import com.music.play.databinding.ActivityRecordListBinding;
...
public class RecordListActivity extends BaseActivity<ActivityRecordListBinding> {
    ...
    @Override
    protected ActivityRecordListBinding getViewBinding() {
        return ActivityRecordListBinding.inflate(getLayoutInflater());
    }
